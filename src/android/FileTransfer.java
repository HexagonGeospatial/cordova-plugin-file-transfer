                ...
                try {
                    ...
                    if (!cached) {
                        ...
                        if (filePlugin != null) {
                            ...
                            if (fileEntry != null) {
                                FileDownloadResult fileDownloadResult = new FileDownloadResult(fileEntry, connection);
                                result = new PluginResult(PluginResult.Status.OK, fileDownloadResult.toJSONObject());
                            } else {
